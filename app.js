  ...
  view.innerHTML=`
    <section class="card hero hero-with-avatar">
      ...
      <div class="hero-avatar-wrap" aria-label="Main character avatar">
        <img class="hero-avatar" src="assets/female-avatar-bust.jpg?v=2.3" alt="Soft and friendly female cook avatar">
      </div>
    </section>
  ...
  view.innerHTML=`
    <section class="card character-card">
      <div class="character-full-wrap">
        <img class="character-full" src="assets/female-avatar-full.jpg?v=2.3" alt="Female main character avatar">
      </div>
